...
function handlePadChange(e) {
    console.log('handlePadChange', e.name, e.velocity);
}
function handlePadPush(e) {
...
window.testInitialValues = function() {
    console.log(LPD8.K2.velocity);
}